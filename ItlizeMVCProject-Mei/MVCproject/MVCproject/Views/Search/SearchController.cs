...
//using MVCProject_Service
using Category = MVCProject_DAL.Category;
using SubCategory = MVCProject_DAL.SubCategory;

namespace MVCproject.Views.Search
{
    public class SearchController : Controller
    {
        public ActionResult Index(int? value)
        {
            ...
            foreach (var tempCatego in new MVCProject_Service.Service().getCategories())
            {

                Category tempObj = new Category();
                //SubCategory tempSubCategory = new SubCategory();
                tempObj.CategoryID = tempCatego.CategoryID;
                tempObj.CategoryName = tempCatego.CategoryName;
            ...
            if (value != null)
            {
                ...
                List<string> subCategoList = new List<string>();
                int val = (int)value;
                foreach (var temp in new MVCProject_Service.Service().GetSubCategories(val))
                {
                    subCategoList.Add(temp.SubCategory_Name);
                }
